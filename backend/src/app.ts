...
import { tempDownloadRoutes } from "./routes/temp-download.routes.js"; // TEMPORARY — see temp-download.routes.ts
...
await app.register(tempDownloadRoutes); // TEMPORARY — see temp-download.routes.ts
